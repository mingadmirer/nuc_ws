...
class DetectionResult(metaclass=Metaclass_DetectionResult):
    ...
    def __init__(self, **kwargs):
        ...
        self.depth_mm = kwargs.get('depth_mm', float())
        from builtin_interfaces.msg import Time
    ...
    def __eq__(self, other):
        ...
        if self.confidence != other.confidence:
            return False
        if self.depth_mm != other.depth_mm:
            return False
    ...
    def depth_mm(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'depth_mm' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'depth_mm' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._depth_mm = value
