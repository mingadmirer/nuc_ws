#ifndef BLUEMISSION_NODE_H
#define BLUEMISSION_NODE_H
 ...
 */
class BlueMissionNode : public rclcpp::Node {
public:
    enum State {
        INIT,
        ALIGN_RACK,
    ...
    explicit BlueMissionNode(const rclcpp::NodeOptions& opts = rclcpp::NodeOptions());
    ~BlueMissionNode() override;
